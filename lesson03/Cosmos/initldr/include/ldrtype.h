...
#define ILDRKRL_PHYADR 0x200000         // 2MB
#define IMGSHEL_PHYADR 0x30000          // 192KB
#define IKSTACK_PHYADR (0x90000-0x10)
#define IKSTACK_SIZE 0x1000             // 4KB
#define IMGFILE_PHYADR 0x4000000        // 64MB
#define IMGKRNL_PHYADR 0x2000000        // 32MB
#define KINITPAGE_PHYADR 0x1000000      // 16MB
#define KINITFRVM_PHYADR 0x800000       // 8MB
#define KINITFRVM_SZ 0x400000           // 4MB
...
typedef struct s_MACHBSTART
{
    ...
    u64_t   mb_cpumode;       // 机器 CPU 工作模式
    u64_t   mb_memsz;         // 机器内存大小
    u64_t   mb_e820padr;      // 机器 e820 数组地址
    u64_t   mb_e820nr;        // 机器 e820 数组元素个数
    u64_t   mb_e820sz;        // 机器 e820 数组大小
    u64_t   mb_e820expadr;
    u64_t   mb_e820exnr;
    u64_t   mb_e820exsz;
    u64_t   mb_memznpadr;
...
#define MBSPADR ((machbstart_t*)(0x100000)) // 1MB
